...
function exportUI(Component, componentName) {
  var ComponentUI = (function (_React$Component) {
    ...
    ComponentUI.prototype.buildStyle = function buildStyle() {
      ...
      var styles = [this.buildElementStyle(componentName), uiStyle, componentName, className, this.buildAnimationStyle()];
    ...
    ComponentUI.prototype.buildAnimationStyle = function buildAnimationStyle() {
      var _classNames;

      if (!this.state.animation && _constantsVisualEffects2['default'].transitions.indexOf(this.state.animation) === -1 && _constantsVisualEffects2['default'].animations.indexOf(this.state.animation) === -1) {
        return;
      }
      var isTransition = _constantsVisualEffects2['default'].animations.indexOf(this.state.animation) === -1;
      ...
      }, _classNames[this.state.animation] = this.state.animating, _classNames));
    };

    ComponentUI.prototype.setAnimationTimeout = function setAnimationTimeout() {
      var _this2 = this;
