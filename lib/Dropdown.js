...
var Dropdown = (function (_Component) {
  ...
  Dropdown.prototype.render = function render() {
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'div',
        { className: this.state.valid ? 'field' : 'required field error' },
  ...
  Dropdown.prototype.validate = function validate() {
    var updateState = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];

    var valid = !(this.props.required && !this.state.value);
